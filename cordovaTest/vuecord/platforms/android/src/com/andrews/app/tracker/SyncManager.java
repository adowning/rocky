...
//    private ArrayList<String> foodmenuList = new ArrayList<>();
//    private ArrayList<String> showsalesList = new ArrayList<>();
//
//    //It is a sync listener for downstream Sync
//    SyncListener foodMenuSyncListener;
//
//    static private SyncManager thisInstance = null;
//
...
//                    SyncManager.getInstance().clearFoodMenuItems();
//
//                    //Adding find options
...
//                        String s = "adsf";
////                        String foodmenu_item = new Location(Map<String, String> s);
//
//                        //Adding data  object to the singleton class
//                        String foodmenu_item = "adf";
//                        SyncManager.getInstance().addFoodMenuItems(foodmenu_item);
//                    }
//                    Log.d("Item:", displayText.toString());
//                    //This foodSyncComplete function is written for making progress bar invisible
//                    foodMenuSyncListener.syncComplete("Sync Done Successfully!!");
//                }
//                catch (Exception e) {
...
//                    foodMenuSyncListener.syncComplete("Sync Call Failed");
//
...
//    public void addFoodMenuItems(String menuItems) {
//        foodmenuList.add(menuItems);
//    }
//    //This function will add the sale objects to the showsaleList
//    public void addMakeSaleItems(String saleitems){
...
//    public void syncFoodMenu(SyncListener foodMenuSyncListener)
//    {
