...
import com.andrews.app.MainActivity;
...
//            syncIntent = new Intent(getApplicationContext(), DBAdapter.class);
            ...
            if (db.needsSync()) {
                Log.d(TAG, "strarting sync service ");
...
//                        .setContentText(String.format(getString(R.string.is_running), getString(R.string.app_name)));
    ...
    private void createNotificationChannel(String channelId) {
        NotificationChannel chan = new NotificationChannel(channelId, "AndrewAdmin", NotificationManager.IMPORTANCE_HIGH);
